...
bool PIC8259::signalInterrupt(int intnum)
{
  ...
  bool success = false;
  intnum &= 7;  //set all but the lower 3 bits to zero
  // already servicing?
  if ((m_ISR & (1 << intnum)) == 0) 
  {
...
bool PIC8259::forceSignalInterrupt(int intnum)
{
  //printf("PIC8259::signalInterrupt(%d)\n", intnum);
  bool success = false;
  intnum &= 7;
...
uint8_t *PIC8259::get_m_state(){return &m_state;}
uint8_t *PIC8259::get_m_baseVector(){return &m_baseVector;} 
bool    *PIC8259::get_m_autoEOI(){return &m_autoEOI;}
uint8_t *PIC8259::get_m_IRR(){return &m_IRR;} 
uint8_t *PIC8259::get_m_ISR(){return &m_ISR;}
uint8_t *PIC8259::get_m_IMR(){return &m_IMR;} 
bool    *PIC8259::get_m_readISR(){return &m_readISR;}
bool    *PIC8259::get_m_pendingInterrupt(){return &m_pendingInterrupt;}
uint8_t *PIC8259::get_m_pendingIR(){return &m_pendingIR;}
