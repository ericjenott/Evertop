...
#define FABGLIB_MINFREELARGESTBLOCK 10000
...
//#define FABGLIB_VIDEO_CPUINTENSIVE_TASKS_CORE (WIFI_TASK_CORE_ID) // using the same core of WiFi may cause flickering
