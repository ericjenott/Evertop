...
enum PrimitiveCmd : uint8_t {
  ...
  // params: rect
  FillRect,  //NEED TO CHECK THIS OUT!
  ...
  // params: path
  FillPath,  //NEED TO CHECK THIS OUT!
...
public:
  ...
  virtual void setResolution(int viewPortWidth = -1, int viewPortHeight = -1, bool clearScreen = true) = 0;
