...
{
  //printf("inside Keyboard::begin(bool generateVirtualKeys, bool createVKQueue, int PS2Port)\n");
  //printf("generateVirtualKeys = %d, createVKQueue = %d, PS2Port = %d\n", (int)generateVirtualKeys, (int)createVKQueue, (int)PS2Port);
  ...
  m_uiApp = nullptr;
  //printf("calling Keyboard::reset()\n");
  reset();
  //printf("returned from Keyboard::reset()\n");
  enableVirtualKeys(generateVirtualKeys, createVKQueue);
  //printf("returned from enableVirtualKeys(generateVirtualKeys, createVKQueue);\n");
}


void Keyboard::begin(gpio_num_t clkGPIO, gpio_num_t dataGPIO, bool generateVirtualKeys, bool createVKQueue)
{
  //printf("inside Keyboard::begin(gpio_num_t clkGPIO, gpio_num_t dataGPIO, bool generateVirtualKeys, bool createVKQueue)\n");
...
{
  //printf("inside Keyboard::enableVirtualKeys(bool generateVirtualKeys, bool createVKQueue), generateVirtualKeys = %d, createVKQueue = %d\n", (int)generateVirtualKeys, (int)createVKQueue);
...
bool Keyboard::reset()
{
  ...
  printf("m_keyboardAvailable = %d\n", (int)m_keyboardAvailable);
...
{
  //printf("inside Keyboard::setLEDs\n");
...
{
  // this doesn't run when not using virtual keys
  //Serial.printf("inside Keyboard::injectVirtualKey\n");
  // update m_VKMap
  if (item.down)
