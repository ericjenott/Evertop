...
class GxEPD2_583_T8 : public GxEPD2_EPD
{
  public:
    ...
    void writeImageFast(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h);
    void writeImagePartFast(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    ...
    void refreshFast(int16_t x, int16_t y, int16_t w, int16_t h); // screen refresh from controller memory, partial screen
